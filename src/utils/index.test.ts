...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@yvaultswap/sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.MUMBAI, 'abc', 'address')).toEqual('https://polygonscan.com/address/abc')
    })
  })
