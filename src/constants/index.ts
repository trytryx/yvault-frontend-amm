import { ChainId, JSBI, Percent, Token, WETH } from '@yvaultswap/sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

// import { bsc, fortmatic, injected, portis, walletconnect, walletlink } from '../connectors'
import { injected, walletconnect } from '../connectors'
// TODO
export const ROUTER_ADDRESS = process.env.REACT_APP_ROUTER_ADDRESS || '0x9Fa8e4caF99C2A7770B19d5E6f7eCb78F8Da0D37'
export const FACTORY_ADDRESS = process.env.REACT_APP_FACTORY_ADDRESS || '0x4a5c47244da0EACfe66d8Fdb2ce428B230e701ab'
export const INIT_CODE = process.env.INIT_CODE ||  '0xb738c752ef74ac29d08291795fe185039d58902ab7aa6efde8de399d84aea07f'
...
export const YVAULT = new Token(ChainId.MATIC, '0xB2768E31d72B9E1002CF58692A67866c8A1133db', 18, 'YVAULT', 'YvaultSwap')
...
export const TYVAULT = new Token(ChainId.MUMBAI, '0xB2768E31d72B9E1002CF58692A67866c8A1133db', 18, 'YVAULT', 'YvaultSwap')
export const TUSDT = new Token(ChainId.MUMBAI, '0x4e75fD59DE47630F3dCFD8d46308039CdC752Cd1', 18, 'USDT', 'Tether USD')
export const TETH = new Token(ChainId.MUMBAI, '0x0f43c21E1f1bCCA29E2EcAc27999C3F9D9Ba71F5', 18, 'WETH', 'Wrapped Ethereum')
export const TDAI = new Token(ChainId.MUMBAI, '0x688353c065AcaeB3bb96d3aF35b141Fc6C3Ab875', 18, 'DAI', 'Dai Stablecoin')
export const TUSDC = new Token(ChainId.MUMBAI, '0x797414121dcd8990223eB9c6E67c398a4F362CD2', 18, 'USDC', 'USDC')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.MATIC]: [...WETH_ONLY[ChainId.MATIC], USDC, USDT, YVAULT, QUICK, ETHER, WBTC, DAI, MAUSDC],
  [ChainId.MUMBAI]: [...WETH_ONLY[ChainId.MUMBAI], TYVAULT, TUSDT]
}
...
export const CUSTOM_BASES: { [chainId in ChainId]?: { [tokenAddress: string]: Token[] } } = {
  [ChainId.MATIC]: {
    [ETHER.address]: [DAI, WETH[ChainId.MATIC]]
  }
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MATIC]: [...WETH_ONLY[ChainId.MATIC], DAI, USDC, USDT, YVAULT, QUICK, ETHER, WBTC],
  [ChainId.MUMBAI]: [...WETH_ONLY[ChainId.MUMBAI], TYVAULT, TUSDT]
}
