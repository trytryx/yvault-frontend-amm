            ...
            <>
              ...
              <Body color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive YVAULT rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to YVAULT.'}
              </Body>
            </>
          )}
          <RowBetween>
